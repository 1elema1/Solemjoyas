  ...
  return (
    <nav style={{ backgroundColor: '#F5F0E8', borderBottom: '1px solid rgba(0,0,0,0.08)' }} className="sticky top-0 z-50 w-full">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-6">
        ...
        {/* Center: Logo */}
        <button onClick={handleLogoClick} className="flex flex-col items-center gap-1 flex-shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <span style={{ color: '#1a1a1a', fontSize: '0.8rem' }} className="hidden md:block">
